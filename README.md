...
- [done] Add proper `meta` tag for a responsive site to `index.html`
- [done] Add styles.css with the /proper `link` tag.
- [done ] Best efforts to convert HTML (divs) to semantic HTML.
- [ done used grid] Create a 2 column layout using `grid` or `flexbox` for the content using the existing media query in `styles.css`.
- [done ] Replace image placeholders with images from `img` folder.
- [done ] Link the `click here` link to the story page in the `stories` folder.
